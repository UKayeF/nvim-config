...
-- Use treesitter for intelligent, syntax-aware folding
vim.o.foldmethod = 'expr'
vim.o.foldexpr = 'nvim_treesitter#foldexpr()'
vim.o.foldlevel = 99 -- Start with all folds open
vim.o.foldlevelstart = 99 -- Open all folds when opening a file
vim.o.foldenable = true -- Enable folding
vim.o.foldcolumn = '1' -- Show fold column on the left (0-9, higher = wider)
...
-- Folding keymaps (use standard vim fold commands)
...
-- [[ Define NvimTree diagnostic signs early ]]
-- These need to be defined before nvim-tree loads to avoid sign errors
